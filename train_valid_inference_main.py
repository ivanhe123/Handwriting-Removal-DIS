...
if __name__ == "__main__":
    ...
    if hypar["mode"] == "train":
        ...
        hypar["model_path"] ="./models" ## model weights saving (or restoring) path
        hypar["restore_model"] = "" 
    ...
    hypar["early_stop"] = 5 ## stop the training when no improvement in the past 20 validation periods, smaller numbers can be used here e.g., 5 or 10.
